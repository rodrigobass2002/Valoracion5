...
// ================================
// FETCH API (MODIFICADO SOLO AQUÍ)
// ================================
document.getElementById('fetchData').addEventListener('click', async () => {
    const result = document.getElementById('fetchResult');
    result.innerHTML = '<p>Cargando datos...</p>';

    // Simulación de carga (mantiene el comportamiento visual)
    setTimeout(() => {
        result.innerHTML = `
            <p><strong>Nombre:</strong> Jesus Rodrigo</p>
            <p><strong>Email:</strong> rodrigobrailco@gmail.com</p>
            <p><strong>Ciudad:</strong> Santa Cruz de la Sierra</p>
